<template>
    <section class="relative flex justify-center">
        ...
        <figure class="">
            <img src="/img/bannerMenWomen/coupleHiking.jpg" alt="Couple hiking">
            <figcaption class="bg-webSite-lightGray text-xs"><a href="https://stocksnap.io/photo/couple-hiking-WHUJMBFEPO">Photo</a> by <a href="https://stocksnap.io/author/mattbangophotos">Matt Bango</a> on <a href="https://stocksnap.io">StockSnap</a></figcaption>
        </figure>
    </section>
</template>
